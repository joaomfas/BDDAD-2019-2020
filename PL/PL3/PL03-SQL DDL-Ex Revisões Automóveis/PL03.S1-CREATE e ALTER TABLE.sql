...
CREATE TABLE revisoes(
    matricula               CHAR(8)                        CONSTRAINT  pk_revisoes_matricula    PRIMARY KEY
                                                           CONSTRAINT  fk_revisoes_matricula    REFERENCES Automoveis(matricula), 
    data_hora_marcacao      TIMESTAMP,
    efetuada                CHAR(1) DEFAULT ON NULL 'N'    CONSTRAINT ck_revisoes_efetuada     CHECK(REGEXP_LIKE(efetuada, 'S|N', '1'))
);
